...
import (
	"github.com/capsocrates/advent-of-code/day04"
...
var (
	part1ExampleInput = `ecl:gry pid:860033327 eyr:2020 hcl:#fffffd
...
iyr:2011 ecl:brn hgt:59in`
	...
	part2ExampleInput = `eyr:1972 cid:100
...
ecl:#ae12d3 hgt:74cm cid:239 hcl:z pid:345439730 iyr:1924 byr:2029 eyr:2031`
	...
	part2Keys = map[string]func(string) (bool, error) {
		"byr": day04.CheckBirthYear,
		"iyr": day04.CheckIssueYear,
		"eyr": day04.CheckExpirationYear,
		"hgt": day04.CheckHeight,
		"hcl": day04.CheckHairColor,
		"ecl": day04.CheckEyeColor,
		"pid": day04.CheckPassportId,
		"cid": day04.CheckCountryId,
	}
)

func TestCheckBirthYearDay04(t *testing.T) {
	t.Run("Valid", func (t *testing.T) {
		result, err := day04.CheckBirthYear("1920")
		assert.Nil(t, err, err)
		assert.True(t, result)

		result, err = day04.CheckBirthYear("1950")
		assert.Nil(t, err, err)
		assert.True(t, result)

		result, err = day04.CheckBirthYear("1975")
		assert.Nil(t, err, err)
		assert.True(t, result)

		result, err = day04.CheckBirthYear("1999")
		assert.Nil(t, err, err)
		assert.True(t, result)

		result, err = day04.CheckBirthYear("2000")
		assert.Nil(t, err, err)
		assert.True(t, result)

		result, err = day04.CheckBirthYear("2002")
		assert.Nil(t, err, err)
		assert.True(t, result)
	})
	t.Run("Invalid", func (t *testing.T) {
		result, err := day04.CheckBirthYear("1919")
		assert.Nil(t, err, err)
		assert.False(t, result)

		result, err = day04.CheckBirthYear("19500")
		assert.Nil(t, err, err)
		assert.False(t, result)

		result, err = day04.CheckBirthYear("197")
		assert.Nil(t, err, err)
		assert.False(t, result)

		result, err = day04.CheckBirthYear("999")
		assert.Nil(t, err, err)
		assert.False(t, result)

		result, err = day04.CheckBirthYear("20000")
		assert.Nil(t, err, err)
		assert.False(t, result)

		result, err = day04.CheckBirthYear("2003")
		assert.Nil(t, err, err)
		assert.False(t, result)

		result, err = day04.CheckBirthYear("abc123")
		assert.NotNil(t, err)
		assert.False(t, result)

		result, err = day04.CheckBirthYear("123abc")
		assert.NotNil(t, err)
		assert.False(t, result)
	})
}

func BenchmarkCheckBirthYearValidDay04(b *testing.B) {
	for i := 0; i <= b.N; i++ {
		day04.CheckBirthYear("2000")
	}
}

func BenchmarkCheckBirthYearInvalidDay04(b *testing.B) {
	for i := 0; i <= b.N; i++ {
		day04.CheckBirthYear("2003")
	}
}

func BenchmarkCheckBirthYearBadInputDay04(b *testing.B) {
	for i := 0; i <= b.N; i++ {
		day04.CheckBirthYear("abc123")
	}
}

func TestCheckIssueYearDay04(t *testing.T) {
	t.Run("Valid", func (t *testing.T) {
		result, err := day04.CheckIssueYear("2010")
		assert.Nil(t, err, err)
		assert.True(t, result)

		result, err = day04.CheckIssueYear("2012")
		assert.Nil(t, err, err)
		assert.True(t, result)

		result, err = day04.CheckIssueYear("2015")
		assert.Nil(t, err, err)
		assert.True(t, result)

		result, err = day04.CheckIssueYear("2018")
		assert.Nil(t, err, err)
		assert.True(t, result)

		result, err = day04.CheckIssueYear("2020")
		assert.Nil(t, err, err)
		assert.True(t, result)
	})
	t.Run("Invalid", func (t *testing.T) {
		result, err := day04.CheckIssueYear("1919")
		assert.Nil(t, err, err)
		assert.False(t, result)

		result, err = day04.CheckIssueYear("19500")
		assert.Nil(t, err, err)
		assert.False(t, result)

		result, err = day04.CheckIssueYear("197")
		assert.Nil(t, err, err)
		assert.False(t, result)

		result, err = day04.CheckIssueYear("2009")
		assert.Nil(t, err, err)
		assert.False(t, result)

		result, err = day04.CheckIssueYear("20000")
		assert.Nil(t, err, err)
		assert.False(t, result)

		result, err = day04.CheckIssueYear("2021")
		assert.Nil(t, err, err)
		assert.False(t, result)

		result, err = day04.CheckIssueYear("abc123")
		assert.NotNil(t, err)
		assert.False(t, result)

		result, err = day04.CheckIssueYear("123abc")
		assert.NotNil(t, err)
		assert.False(t, result)
	})
}

func BenchmarkCheckIssueYearValidDay04(b *testing.B) {
	for i := 0; i <= b.N; i++ {
		day04.CheckIssueYear("2015")
	}
}

func BenchmarkCheckIssueYearInvalidDay04(b *testing.B) {
	for i := 0; i <= b.N; i++ {
		day04.CheckIssueYear("2003")
	}
}

func BenchmarkCheckIssueYearBadInputDay04(b *testing.B) {
	for i := 0; i <= b.N; i++ {
		day04.CheckIssueYear("abc123")
	}
}

func TestCheckExpirationYearDay04(t *testing.T) {
	t.Run("Valid", func (t *testing.T) {
		result, err := day04.CheckExpirationYear("2020")
		assert.Nil(t, err, err)
		assert.True(t, result)

		result, err = day04.CheckExpirationYear("2022")
		assert.Nil(t, err, err)
		assert.True(t, result)

		result, err = day04.CheckExpirationYear("2025")
		assert.Nil(t, err, err)
		assert.True(t, result)

		result, err = day04.CheckExpirationYear("2028")
		assert.Nil(t, err, err)
		assert.True(t, result)

		result, err = day04.CheckExpirationYear("2030")
		assert.Nil(t, err, err)
		assert.True(t, result)
	})
	t.Run("Invalid", func (t *testing.T) {
		result, err := day04.CheckExpirationYear("1919")
		assert.Nil(t, err, err)
		assert.False(t, result)

		result, err = day04.CheckExpirationYear("2019")
		assert.Nil(t, err, err)
		assert.False(t, result)

		result, err = day04.CheckExpirationYear("19500")
		assert.Nil(t, err, err)
		assert.False(t, result)

		result, err = day04.CheckExpirationYear("197")
		assert.Nil(t, err, err)
		assert.False(t, result)

		result, err = day04.CheckExpirationYear("2009")
		assert.Nil(t, err, err)
		assert.False(t, result)

		result, err = day04.CheckExpirationYear("20000")
		assert.Nil(t, err, err)
		assert.False(t, result)

		result, err = day04.CheckExpirationYear("2031")
		assert.Nil(t, err, err)
		assert.False(t, result)

		result, err = day04.CheckExpirationYear("abc123")
		assert.NotNil(t, err)
		assert.False(t, result)

		result, err = day04.CheckExpirationYear("123abc")
		assert.NotNil(t, err)
		assert.False(t, result)
	})
}

func BenchmarkCheckExpirationYearValidDay04(b *testing.B) {
	for i := 0; i <= b.N; i++ {
		day04.CheckExpirationYear("2025")
	}
}

func BenchmarkCheckExpirationYearInvalidDay04(b *testing.B) {
	for i := 0; i <= b.N; i++ {
		day04.CheckExpirationYear("2003")
	}
}

func BenchmarkCheckExpirationYearBadInputDay04(b *testing.B) {
	for i := 0; i <= b.N; i++ {
		day04.CheckExpirationYear("abc123")
	}
}

func TestCheckHeightDay04(t *testing.T) {
	t.Run("Valid", func (t *testing.T) {
		result, err := day04.CheckHeight("59in")
		assert.Nil(t, err, err)
		assert.True(t, result)

		result, err = day04.CheckHeight("65in")
		assert.Nil(t, err, err)
		assert.True(t, result)

		result, err = day04.CheckHeight("76in")
		assert.Nil(t, err, err)
		assert.True(t, result)

		result, err = day04.CheckHeight("150cm")
		assert.Nil(t, err, err)
		assert.True(t, result)

		result, err = day04.CheckHeight("177cm")
		assert.Nil(t, err, err)
		assert.True(t, result)

		result, err = day04.CheckHeight("193cm")
		assert.Nil(t, err, err)
		assert.True(t, result)
	})
	t.Run("Invalid", func (t *testing.T) {
		result, err := day04.CheckHeight("58in")
		assert.Nil(t, err, err)
		assert.False(t, result)

		result, err = day04.CheckHeight("77in")
		assert.Nil(t, err, err)
		assert.False(t, result)

		result, err = day04.CheckHeight("149cm")
		assert.Nil(t, err, err)
		assert.False(t, result)

		result, err = day04.CheckHeight("194cm")
		assert.Nil(t, err, err)
		assert.False(t, result)

		result, err = day04.CheckHeight("in")
		require.NotNil(t, err)
		assert.Equal(t, "incorrect string length", err.Error())
		assert.False(t, result)

		result, err = day04.CheckHeight("1945cm")
		require.NotNil(t, err)
		assert.Equal(t, "incorrect string length", err.Error())
		assert.False(t, result)

		result, err = day04.CheckHeight("4877")
		require.NotNil(t, err)
		assert.Equal(t, "missing height type", err.Error())
		assert.False(t, result)

		result, err = day04.CheckHeight("177ft")
		require.NotNil(t, err)
		assert.Equal(t, "missing height type", err.Error())
		assert.False(t, result)
	})
...
func BenchmarkCheckHeightValidDay04(b *testing.B) {
	for i := 0; i <= b.N; i++ {
		day04.CheckHeight("65in")
	}
}

func BenchmarkCheckHeightInvalidDay04(b *testing.B) {
	for i := 0; i <= b.N; i++ {
		day04.CheckHeight("77in")
	}
}

func BenchmarkCheckHeightBadInputDay04(b *testing.B) {
	for i := 0; i <= b.N; i++ {
		day04.CheckHeight("17ft")
	}
}

func TestCheckHairColorDay04(t *testing.T) {
	t.Run("Valid", func (t *testing.T) {
		result, err := day04.CheckHairColor("#123abc")
		assert.Nil(t, err, err)
		assert.True(t, result)

		result, err = day04.CheckHairColor("#123456")
		assert.Nil(t, err, err)
		assert.True(t, result)

		result, err = day04.CheckHairColor("#ffffff")
		assert.Nil(t, err, err)
		assert.True(t, result)

		result, err = day04.CheckHairColor("#aaaaaa")
		assert.Nil(t, err, err)
		assert.True(t, result)

		result, err = day04.CheckHairColor("#000000")
		assert.Nil(t, err, err)
		assert.True(t, result)

		result, err = day04.CheckHairColor("#999999")
		assert.Nil(t, err, err)
		assert.True(t, result)
	})
	t.Run("Invalid", func (t *testing.T) {
		result, err := day04.CheckHairColor("#123abz")
		assert.Nil(t, err, err)
		assert.False(t, result)
		...
		result, err = day04.CheckHairColor("#fffffg")
		assert.Nil(t, err, err)
		assert.False(t, result)

		result, err = day04.CheckHairColor("#gggggg")
		assert.Nil(t, err, err)
		assert.False(t, result)

		result, err = day04.CheckHairColor("#123ab")
		require.NotNil(t, err)
		assert.Equal(t, "incorrect string length", err.Error())
		assert.False(t, result)

		result, err = day04.CheckHairColor("#123abcd")
		require.NotNil(t, err)
		assert.Equal(t, "incorrect string length", err.Error())
		assert.False(t, result)
...
func BenchmarkCheckHairColorValidDay04(b *testing.B) {
	for i := 0; i <= b.N; i++ {
		day04.CheckHairColor("#ffffff")
	}
}

func BenchmarkCheckHairColorInvalidDay04(b *testing.B) {
	for i := 0; i <= b.N; i++ {
		day04.CheckHairColor("#fffffg")
	}
}

func BenchmarkCheckHairColorBadInputDay04(b *testing.B) {
	for i := 0; i <= b.N; i++ {
		day04.CheckHairColor("#123abcd")
	}
}

func BenchmarkCheckHairColorBadInput2Day04(b *testing.B) {
	for i := 0; i <= b.N; i++ {
		day04.CheckHairColor("123abcd")
	}
}

func TestCheckEyeColorDay04(t *testing.T) {
	t.Run("Valid", func (t *testing.T) {
		result, err := day04.CheckEyeColor("amb")
		assert.Nil(t, err, err)
		assert.True(t, result)

		result, err = day04.CheckEyeColor("blu")
		assert.Nil(t, err, err)
		assert.True(t, result)

		result, err = day04.CheckEyeColor("brn")
		assert.Nil(t, err, err)
		assert.True(t, result)

		result, err = day04.CheckEyeColor("grn")
		assert.Nil(t, err, err)
		assert.True(t, result)

		result, err = day04.CheckEyeColor("hzl")
		assert.Nil(t, err, err)
		assert.True(t, result)

		result, err = day04.CheckEyeColor("oth")
		assert.Nil(t, err, err)
		assert.True(t, result)
	})
	t.Run("Invalid", func (t *testing.T) {
		result, err := day04.CheckEyeColor("yel")
		assert.Nil(t, err, err)
		assert.False(t, result)

		result, err = day04.CheckEyeColor("whi")
		assert.Nil(t, err, err)
		assert.False(t, result)

		result, err = day04.CheckEyeColor("blk")
		assert.Nil(t, err, err)
		assert.False(t, result)

		result, err = day04.CheckEyeColor("rd")
		require.NotNil(t, err)
		assert.Equal(t, "incorrect string length", err.Error())
		assert.False(t, result)

		result, err = day04.CheckEyeColor("blue")
		require.NotNil(t, err)
		assert.Equal(t, "incorrect string length", err.Error())
		assert.False(t, result)
	})
...
func BenchmarkCheckEyeColorValidDay04(b *testing.B) {
	for i := 0; i <= b.N; i++ {
		day04.CheckEyeColor("oth")
	}
}

func BenchmarkCheckEyeColorInvalidDay04(b *testing.B) {
	for i := 0; i <= b.N; i++ {
		day04.CheckEyeColor("blk")
	}
}

func BenchmarkCheckEyeColorBadInputDay04(b *testing.B) {
	for i := 0; i <= b.N; i++ {
		day04.CheckEyeColor("blue")
	}
}

func TestCheckPassportIdDay04(t *testing.T) {
	t.Run("Valid", func (t *testing.T) {
		result, err := day04.CheckPassportId("000000000")
		assert.Nil(t, err, err)
		assert.True(t, result)

		result, err = day04.CheckPassportId("000123000")
		assert.Nil(t, err, err)
		assert.True(t, result)

		result, err = day04.CheckPassportId("000000456")
		assert.Nil(t, err, err)
		assert.True(t, result)

		result, err = day04.CheckPassportId("123456789")
		assert.Nil(t, err, err)
		assert.True(t, result)

		result, err = day04.CheckPassportId("912983782")
		assert.Nil(t, err, err)
		assert.True(t, result)

		result, err = day04.CheckPassportId("010980082")
		assert.Nil(t, err, err)
		assert.True(t, result)
	})
	t.Run("Invalid", func (t *testing.T) {
		result, err := day04.CheckPassportId("000000ABC")
		assert.Nil(t, err, err)
		assert.False(t, result)
		...
		result, err = day04.CheckPassportId("abc000000")
		assert.Nil(t, err, err)
		assert.False(t, result)

		result, err = day04.CheckPassportId("0vamgdf00")
		assert.Nil(t, err, err)
		assert.False(t, result)

		result, err = day04.CheckPassportId("ama'tveon")
		assert.Nil(t, err, err)
		assert.False(t, result)

		result, err = day04.CheckPassportId("00000000")
		require.NotNil(t, err)
		assert.Equal(t, "incorrect string length", err.Error())
		assert.False(t, result)

		result, err = day04.CheckPassportId("0000000000")
		require.NotNil(t, err)
		assert.Equal(t, "incorrect string length", err.Error())
		assert.False(t, result)

		result, err = day04.CheckPassportId("123")
		require.NotNil(t, err)
		assert.Equal(t, "incorrect string length", err.Error())
		assert.False(t, result)
	})
...
func BenchmarkCheckPassportIdValidDay04(b *testing.B) {
	for i := 0; i <= b.N; i++ {
		day04.CheckPassportId("010980082")
	}
}

func BenchmarkCheckPassportIdInvalidDay04(b *testing.B) {
	for i := 0; i <= b.N; i++ {
		day04.CheckPassportId("0ma'tveon")
	}
}

func BenchmarkCheckPassportIdBadInputDay04(b *testing.B) {
	for i := 0; i <= b.N; i++ {
		day04.CheckPassportId("123")
	}
}

func TestSplitBlobToStringsExampleDay04(t *testing.T) {
	result := day04.SplitBlobToStrings(part1ExampleInput)

	require.Equal(t, 4, len(result))

	assert.Equal(t, "ecl:gry pid:860033327 eyr:2020 hcl:#fffffd byr:1937 iyr:2017 cid:147 hgt:183cm", result[0])

	assert.Equal(t, "iyr:2013 ecl:amb cid:350 eyr:2023 pid:028048884 hcl:#cfa07d byr:1929", result[1])

	assert.Equal(t, "hcl:#ae17e1 iyr:2013 eyr:2024 ecl:brn pid:760753108 byr:1931 hgt:179cm", result[2])

	assert.Equal(t, "hcl:#cfa07d eyr:2025 pid:166559648 iyr:2011 ecl:brn hgt:59in", result[3])
}

func BenchmarkSplitBlobToStringsExampleDay04(b *testing.B) {
	for i := 0; i <= b.N; i++ {
		day04.SplitBlobToStrings(part1ExampleInput)
	}
}

func TestSplitBlobToStringsProblemDay04(t *testing.T) {
	result := day04.SplitBlobToStrings(problemInput)

	require.Equal(t, 282, len(result))
	assert.Equal(t, "ecl:grn cid:315 iyr:2012 hgt:192cm eyr:2023 pid:873355140 byr:1925 hcl:#cb2c03", result[0])
	assert.Equal(t, "ecl:#ae12d3 hgt:74cm cid:239 hcl:z pid:345439730 iyr:1924 byr:2029 eyr:2031", result[281])
}

func BenchmarkSplitBlobToStringsProblemDay04(b *testing.B) {
	for i := 0; i <= b.N; i++ {
		day04.SplitBlobToStrings(problemInput)
	}
}

func TestCheckKeysPart1Day04(t *testing.T) {
	t.Run("Valid", func (t *testing.T) {
		result := day04.CheckKeysPart1(`ecl:gry pid:860033327 eyr:2020 hcl:#fffffd byr:1937 iyr:2017 cid:147 hgt:183cm`, part1Keys)
		assert.True(t, result)

		result = day04.CheckKeysPart1(`hcl:#ae17e1 iyr:2013 eyr:2024 ecl:brn pid:760753108 byr:1931 hgt:179cm`, part1Keys)
		assert.True(t, result)
	})
	t.Run("Invalid", func (t *testing.T) {
		result := day04.CheckKeysPart1(`iyr:2013 ecl:amb cid:350 eyr:2023 pid:028048884 hcl:#cfa07d byr:1929`, part1Keys)
		assert.False(t, result)

		result = day04.CheckKeysPart1(`hcl:#cfa07d eyr:2025 pid:166559648 iyr:2011 ecl:brn hgt:59in`, part1Keys)
		assert.False(t, result)
	})
}

func BenchmarkCheckKeysPart1ValidDay04(b *testing.B) {
	for i := 0; i <= b.N; i++ {
		day04.CheckKeysPart1(`ecl:gry pid:860033327 eyr:2020 hcl:#fffffd byr:1937 iyr:2017 cid:147 hgt:183cm`, part1Keys)
	}
}

func BenchmarkCheckKeysPart1InvalidDay04(b *testing.B) {
	for i := 0; i <= b.N; i++ {
		day04.CheckKeysPart1(`iyr:2013 ecl:amb cid:350 eyr:2023 pid:028048884 hcl:#cfa07d byr:1929`, part1Keys)
	}
}
func TestCountValidIdsPart1ExampleDay04(t *testing.T) {
	count := day04.CountValidIdsPart1(part1ExampleInput, part1Keys)

	assert.Equal(t, 2, count)
}

func BenchmarkCountValidIdsPart1ExampleDay04(b *testing.B) {
	for i := 0; i <= b.N; i++ {
		day04.CountValidIdsPart1(part1ExampleInput, part1Keys)
	}
}

func TestCountValidIdsPart1ProblemDay04(t *testing.T) {
	count := day04.CountValidIdsPart1(problemInput, part1Keys)

	assert.Equal(t, 226, count)
}

func BenchmarkCountValidIdsPart1ProblemDay04(b *testing.B) {
	for i := 0; i <= b.N; i++ {
		day04.CountValidIdsPart1(problemInput, part1Keys)
	}
}

func TestCheckKeysPart2Day04(t *testing.T) {
	t.Run("Valid", func (t *testing.T) {
		result := day04.CheckKeysPart2(`ecl:gry pid:860033327 eyr:2020 hcl:#fffffd byr:1937 iyr:2017 cid:147 hgt:183cm`, part2Keys)
		assert.True(t, result)

		result = day04.CheckKeysPart2(`pid:087499704 hgt:74in ecl:grn iyr:2012 eyr:2030 byr:1980 hcl:#623a2f`, part2Keys)
		assert.True(t, result)

		result = day04.CheckKeysPart2(`eyr:2029 ecl:blu cid:129 byr:1989 iyr:2014 pid:896056539 hcl:#a97842 hgt:165cm`, part2Keys)
		assert.True(t, result)

		result = day04.CheckKeysPart2(`hcl:#888785 hgt:164cm byr:2001 iyr:2015 cid:88 pid:545766238 ecl:hzl eyr:2022`, part2Keys)
		assert.True(t, result)

		result = day04.CheckKeysPart2(`iyr:2010 hgt:158cm hcl:#b6652a ecl:blu byr:1944 eyr:2021 pid:093154719`, part2Keys)
		assert.True(t, result)
	})
	t.Run("Invalid", func (t *testing.T) {
		result := day04.CheckKeysPart2(`iyr:2013 ecl:amb cid:350 eyr:2023 pid:028048884 hcl:#cfa07d byr:1929`, part2Keys)
		assert.False(t, result)

		result = day04.CheckKeysPart2(`eyr:1972 cid:100 hcl:#18171d ecl:amb hgt:170 pid:186cm iyr:2018 byr:1926`, part2Keys)
		assert.False(t, result)

		result = day04.CheckKeysPart2(`iyr:2019 hcl:#602927 eyr:1967 hgt:170cm ecl:grn pid:012533040 byr:1946`, part2Keys)
		assert.False(t, result)

		result = day04.CheckKeysPart2(`hcl:dab227 iyr:2012 ecl:brn hgt:182cm pid:021572410 eyr:2020 byr:1992 cid:277`, part2Keys)
		assert.False(t, result)

		result = day04.CheckKeysPart2(`hgt:59cm ecl:zzz eyr:2038 hcl:74454a iyr:2023 pid:3556412378 byr:2007`, part2Keys)
		assert.False(t, result)
	})
}

func BenchmarkCheckKeysPart2ValidDay04(b *testing.B) {
	for i := 0; i <= b.N; i++ {
		day04.CheckKeysPart2(`eyr:2029 ecl:blu cid:129 byr:1989 iyr:2014 pid:896056539 hcl:#a97842 hgt:165cm`, part2Keys)
	}
}

func BenchmarkCheckKeysPart2InvalidDay04(b *testing.B) {
	for i := 0; i <= b.N; i++ {
		day04.CheckKeysPart2(`hgt:59cm ecl:zzz eyr:2038 hcl:74454a iyr:2023 pid:3556412378 byr:2007`, part2Keys)
	}
}
func TestCountValidIdsPart2ExampleDay04(t *testing.T) {
	count := day04.CountValidIdsPart2(part2ExampleInput, part2Keys)
	assert.Equal(t, 4, count)
}

func BenchmarkCountValidIdsPart2ExampleDay04(b *testing.B) {
	for i := 0; i <= b.N; i++ {
		day04.CountValidIdsPart2(part2ExampleInput, part2Keys)
	}
}

func TestCountValidIdsPart2ProblemDay04(t *testing.T) {
	count := day04.CountValidIdsPart2(problemInput, part2Keys)
	assert.Equal(t, 160, count)
}

func BenchmarkCountValidIdsPart2ProblemDay04(b *testing.B) {
	for i := 0; i <= b.N; i++ {
		day04.CountValidIdsPart2(problemInput, part2Keys)
	}
}
