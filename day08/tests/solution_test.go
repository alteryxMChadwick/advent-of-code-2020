...
func TestParseInstructionsPart1Day08(t *testing.T) {
...
func BenchmarkParseInstructionsExamplePart1Day08(b *testing.B) {
	for i := 0; i < b.N; i++ {
		day08.ParseInstructions(exampleInput)
	}
}

func BenchmarkParseInstructionsProblemPart1Day08(b *testing.B) {
	for i := 0; i < b.N; i++ {
		day08.ParseInstructions(part1Input)
	}
}

func TestRunOnceExamplePart1Day08(t *testing.T) {
	parsed, err := day08.ParseInstructions(exampleInput)
	require.Equal(t, nil, err)
...
var (
	exampleInstructions, _ = day08.ParseInstructions(exampleInput)
	part1Instructions, _ = day08.ParseInstructions(part1Input)
)

func BenchmarkRunOnceExamplePart1Day08(b *testing.B) {
	for i := 0; i < b.N; i++ {
		runner := day08.NewRunner(exampleInstructions)
		runner.RunOnce()
	}
}

func TestRunOnceProblemPart1Day08(t *testing.T) {
	parsed, err := day08.ParseInstructions(part1Input)
	require.Equal(t, nil, err)
	runner := day08.NewRunner(parsed)
	runner.RunOnce()
	assert.Equal(t, 1867, runner.Accumulator())
}

func BenchmarkRunOnceProblemPart1Day08(b *testing.B) {
	for i := 0; i < b.N; i++ {
		runner := day08.NewRunner(part1Instructions)
		runner.RunOnce()
	}
}
