...
import (
	"github.com/capsocrates/advent-of-code/day07"
...
var (
	exampleRules = `light red bags contain 1 bright white bag, 2 muted yellow bags.
...
dotted black bags contain no other bags.`
	...
	part1Rules = `shiny aqua bags contain 1 dark white bag.
...
func TestBuildRulesPart1Day07(t *testing.T) {
	parsedRules, err := day07.BuildRules(exampleRules)
...
func TestCountBagsThatFitExamplePart1Day07(t *testing.T) {
	count, err := day07.CountBagsThatFit(exampleRules, "shiny gold")
	require.Equal(t, nil, err)

	assert.Equal(t, 4, count)
}

func BenchmarkCountBagsThatFitExamplePart1Day07(b *testing.B) {
	for i := 0; i <= b.N; i++ {
		day07.CountBagsThatFit(exampleRules, "shiny gold")
	}
}

func TestCountBagsThatFitProblemPart1Day07(t *testing.T) {
	count, err := day07.CountBagsThatFit(part1Rules, "shiny gold")
	require.Equal(t, nil, err)

	assert.Equal(t, 265, count)
}
